...
public class MainActivity extends AppCompatActivity {
    ...
    private void LoadLogInFragm(){
        ...
        findViewById(R.id.sign_in_button_log).setOnClickListener( (e)-> signIn());
    }
    ...
    private void handleRegResult(Task<GoogleSignInAccount> completedTask) {
        try {
            GoogleSignInAccount account = completedTask.getResult(ApiException.class);
            GoogleRegisteUser(account.getEmail(),account.getDisplayName(),"");
            login(getRidOfSpecialCharacters(account.getEmail()),"");
        } catch (ApiException e) {
            Toast.makeText(MainActivity.this, "Can't log in", Toast.LENGTH_LONG).show();
        }
    ...
    private void GoogleRegisteUser(String email, String name, String pass){
        try {
            String date = ((TextInputEditText) findViewById(R.id.etDate_reg_google)).getText().toString();
    ...
    private void LoadRegFragm(){
        ...
        findViewById(R.id.sign_in_button_reg).setOnClickListener( (e)-> regIn());
    }
